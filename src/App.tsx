    ...
    <div>
      ...
      >
        ...
        <nav style={{ display: 'flex', gap: '2rem', fontSize: '0.9rem' }}>
          <a href="#members" style={{ color: '#3d5229', textDecoration: 'none' }}>
            Medlemmer
          </a>
          <a href="#contact" style={{ color: '#3d5229', textDecoration: 'none' }}>
            Kontakt oss
          </a>
        </nav>
      </div>
      ...
      <div style={{ marginTop: '2rem' }}>
        ...
        >
          <h2 style={{ color: '#3d5229', fontSize: '2rem', marginBottom: '1rem' }}>OM OSS</h2>
          <p>
